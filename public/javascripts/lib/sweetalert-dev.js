...
var getInput = function getInput() {
  var $modal = getModal();
  if ($modal) {
    return $modal.querySelector('.input1');
  }
};

var getInput2 = function getInput2() {
  var $modal = getModal();
  if ($modal) {
    return $modal.querySelector('.input2');
  }
};
...
var resetInput = function resetInput() {
  ...
  $input2.setAttribute('placeholder', _defaultParams2['default'].inputPlaceholder2);
...
"<h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n      <input class= \"input1\" type=\"text\" tabIndex=\"3\" />\n  <input class= \"input2\" type=\"text\" tabIndex=\"3\" style=\"height: 100px;\" />\n      <div class=\"sa-input-error\"></div>\n    </fieldset>" +
